                ...
                <div class="card shadow-sm border-0 mb-4">
                    <div class="card-body p-4 d-flex align-items-center">
                        <div class="avatar avatar-lg me-3">
                            <img src="{{ auth()->user()->avatar ?? asset('images/default-avatar.png') }}" class="rounded-circle" alt="User Avatar">
                        </div>
                        <div>
                                ...
                                <a href="#" class="list-group-item list-group-item-action border-0 py-3 chat-user"
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="position-relative me-3">
                                            <img src="{{ $user->avatar ?? asset('images/default-avatar.png') }}" class="rounded-circle avatar-sm" alt="{{ $user->name }}">
