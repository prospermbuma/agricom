                        ...
                        <div class="col-md-9">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-2">
                                        <strong>Role:</strong> 
                                        <span class="badge bg-{{ auth()->user()->role === 'farmer' ? 'success' : 'info' }}">
                            ...
                            <div class="mt-3">
                                <small class="text-muted">
                                    <i class="fas fa-clock"></i> Last updated: {{ auth()->user()->updated_at->format('F j, Y g:i A') }}
                                </small>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <ul class="list-unstyled mb-0">
                                <li><i class="fas fa-check text-success me-2"></i>Keep your contact information updated</li>
                                <li><i class="fas fa-check text-success me-2"></i>Verify your phone number for better reach</li>
                                @if (auth()->user()->role === 'farmer')
                        ...
                        <div class="col-md-6">
                            <ul class="list-unstyled mb-0">
                                ...
                                @if (auth()->user()->role === 'farmer')
                                    <li><i class="fas fa-check text-success me-2"></i>Update farm size for better matching</li>
                                    <li><i class="fas fa-check text-success me-2"></i>Complete profile attracts more buyers</li>
                                @else
                                    <li><i class="fas fa-check text-success me-2"></i>Complete profile builds trust</li>
                                    <li><i class="fas fa-check text-success me-2"></i>Active profiles get better responses</li>
                                @endif
                            </ul>
                        </div>
                    </div>
