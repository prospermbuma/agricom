                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <select name="crop" class="form-select">
                                ...
                                <option value="maize" {{ request('crop') == 'maize' ? 'selected' : '' }}>Maize</option>
                                <option value="rice" {{ request('crop') == 'rice' ? 'selected' : '' }}>Rice</option>
                                <option value="beans" {{ request('crop') == 'beans' ? 'selected' : '' }}>Beans</option>
                                <option value="cassava" {{ request('crop') == 'cassava' ? 'selected' : '' }}>Cassava</option>
                                <option value="coffee" {{ request('crop') == 'coffee' ? 'selected' : '' }}>Coffee</option>
                        ...
                        <div class="col-md-3">
                            <select name="category" class="form-select">
                                ...
                                <option value="disease" {{ request('category') == 'disease' ? 'selected' : '' }}>Disease Alert</option>
                                <option value="pest" {{ request('category') == 'pest' ? 'selected' : '' }}>Pest Control</option>
                                <option value="technology" {{ request('category') == 'technology' ? 'selected' : '' }}>New Technology</option>
                                <option value="method" {{ request('category') == 'method' ? 'selected' : '' }}>Farming Methods</option>
                                <option value="general" {{ request('category') == 'general' ? 'selected' : '' }}>General Knowledge</option>
                            </select>
                        </div>
                        <div class="col-md-2">
