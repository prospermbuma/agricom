...
<div class="row mt-4">
    <div class="col-md-8">
        <div class="card">
            @if($article->image)
                <img src="{{ asset('storage/' . $article->image) }}" class="card-img-top" style="height: 300px; object-fit: cover;">
            @endif
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('comments.store', $article->id) }}" class="mb-4">
                    ...
                    <div class="mb-3">
                        <textarea name="content" class="form-control @error('content') is-invalid @enderror" 
                                  rows="3" placeholder="Share your thoughts or ask questions..." required>{{ old('content') }}</textarea>
                        @error('content')
    ...
    <div class="col-md-4">
            ...
            <div class="card-body">
                @forelse($relatedArticles ?? [] as $related)
                    <div class="mb-3 border-bottom pb-2">
                        <h6><a href="{{ route('articles.show', $related->id) }}">{{ Str::limit($related->title, 50) }}</a></h6>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                ...
                @endif
                <button class="btn btn-outline-primary btn-sm mt-2" onclick="startChat('{{ $article->author->id }}')">
