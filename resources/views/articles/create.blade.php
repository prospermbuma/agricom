                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="category" class="form-select @error('category') is-invalid @enderror"
                                            ...
                                            <option value="disease" {{ old('category') == 'disease' ? 'selected' : '' }}>
                                                Disease Alert</option>
                                            <option value="pest" {{ old('category') == 'pest' ? 'selected' : '' }}>Pest
                                                Control</option>
                                            <option value="technology"
                                                {{ old('category') == 'technology' ? 'selected' : '' }}>New Technology
                                            </option>
                                            <option value="method" {{ old('category') == 'method' ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="crop" class="form-select @error('crop') is-invalid @enderror">
                                            ...
                                            <option value="maize" {{ old('crop') == 'maize' ? 'selected' : '' }}>Maize
                                            </option>
                                            <option value="rice" {{ old('crop') == 'rice' ? 'selected' : '' }}>Rice
                                            </option>
                                            <option value="beans" {{ old('crop') == 'beans' ? 'selected' : '' }}>Beans
                                            </option>
                                            <option value="cassava" {{ old('crop') == 'cassava' ? 'selected' : '' }}>
                                                Cassava</option>
                                            <option value="coffee" {{ old('crop') == 'coffee' ? 'selected' : '' }}>Coffee
                                            </option>
                                            <option value="cotton" {{ old('crop') == 'cotton' ? 'selected' : '' }}>Cotton
                                            </option>
                                            <option value="sunflower" {{ old('crop') == 'sunflower' ? 'selected' : '' }}>
                                                Sunflower</option>
